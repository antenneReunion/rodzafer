            ...
            <div class="content_header_une">
                <div class="container">
                    <div class="content_head_top">
                        <div class="content_head_top_left"><img src="images/image_left_header_V2.png"
                                                                class="img-responsive"></div>
                        <div class="content_head_top_right"><img src="images/image_right_header.png"
                                                                 class="img-responsive"></div>
                        <img src="images/image_une_mobile.jpg" class="img-responsive image_header_mobile">
                        <div class="content_down_app">
                            <a href="https://play.google.com/store/apps/details?id=com.antennereunion.rodzafer"
                               target="_blank">
                                <img src="images/image_google_play.jpg">
                            </a>
                            <a href="https://itunes.apple.com/us/app/rodzafer/id1450170376?mt=8&ign-mpt=uo%3D2"
                               target="_blank">
        ...
        <div class="list_offre">
            <ul>
              ...
              <span class="logo_partenaire">
                ...
                <span><a href="#telecharger_appli">Téléchargez Rodzafer</a> pour profiter de l’offre</span>
              </span>
                </li>
                <li>
              <span class="logo_partenaire">
            ...
            <div class="bg_gris">
                <div class="container">
                    <div class="owl-carousel owl-theme" id="dernier-affaire">
                        <div class="item">
                            <img src="images/image_livre_darty.png">
                            <span class="content_text_list_catalogue">
                      <span><a href="#telecharger_appli">Téléchargez Rodzafer</a> pour accéder au catalogue</span>
                    </span>
                        </div>
                        <div class="item">
                            <img src="images/image_livre_but.png">
                            <span class="content_text_list_catalogue">
                      <span><a href="#telecharger_appli">Téléchargez Rodzafer</a> pour accéder au catalogue</span>
                    </span>
                        </div>
                        <div class="item">
                            <img src="images/image_livre_comparez.png">
                            <span class="content_text_list_catalogue">
                      <span><a href="#telecharger_appli">Téléchargez Rodzafer</a> pour accéder au catalogue</span>
                    </span>
                        </div>
        ...
        <div class="content_inner_pourquoi">
            <div class="col1 col-md-4">
                <div class="top_content_pourquoi" id="top_left">
                    ...
                    <i id="area-tooltip1" class="area-tooltip" data-toggle="tooltip" data-html="true"
                ...
                <div class="bottom_content_pourquoi " id="bottom_left">
                    ...
                    <i id="area-tooltip2" class="area-tooltip" data-toggle="tooltip" data-html="true"
                       data-placement="right" title=""
                       data-animation="false" data-trigger="manual">&#160;</i>
                </div>
            </div>
            ...
            <div class="col3 col-md-4">
                <div class="top_content_pourquoi" id="top_right">
                    ...
                    <i id=" area-tooltip3 " class="area-tooltip" data-toggle="tooltip" data-html="true"
                       data-placement="right" title="" data-animation="false" data-trigger="manual">&#160;</i>
                </div>
                <div class="bottom_content_pourquoi" id="bottom_right">
                    <img src="images/image_col_3_bottom.png" class="img-responsive">
                    <i id="area-tooltip4" class="area-tooltip" data-toggle="tooltip" data-html="true"
                       data-placement="right" title=""
                       data-animation="false" data-trigger="manual">&#160;</i>
                </div>
            </div>
            ...
            <div class="owl-carousel owl-theme" id="slide_confiance">
                <div class="item">
                    <a href="https://www.lafoirfouille.fr/" target="_blank">
                        <img src="images/image_partenaire_foire_fouille.png">
                    </a>
                </div>
                <div class="item">
                    <a href="https://www.but.fr/" target="_blank">
                        <img src="images/image_partenaire_but.png">
                    </a>
                </div>
                <div class="item">
                    <a href="#">
                        <img src="images/image_partenaire_darty.png">
                    </a>
                </div>
                <div class="item">
                    <a href="https://www.habitat.fr/" target="_blank">
                        <img src="images/image_partenaire_habitat.png">
                    </a>
                </div>
                <div class="item">
                    <a href="http://www.e-leclerc.com/" target="_blank">
                        <img src="images/image_partenaire_leclerc.png">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="list_lien_footer">
            ...
            <ul class="list_bottom">
                ...
                <li>
                    <a href="http://rodzaferlp.ser-rct-01.antennereunion.fr/pdf/ml_rodzafer.pdf" target="_blank">Mentions
                        légales</a>
                </li>
                <li>
                    <a href="http://rodzaferlp.ser-rct-01.antennereunion.fr/pdf/charte_utilisation_ar.pdf"
                       target="_blank">Charte d'utilisation</a>
                </li>
                <li>
                    <a href="http://rodzaferlp.ser-rct-01.antennereunion.fr/pdf/charte_donnee_rodzafer.pdf"
                       target="_blank">Rodzafer</a>
                </li>
            </ul>
        </div>
    </div>
...
<script type="text/javascript"
        src="http://www.dev.domtomauto.com/blog/wp-content/themes/blogdomtomauto/carte_borne_vehicule/js/tooltip.js"></script>
<script>
